...
namespace Tic_Tac_Toe_Web_API.Managers.Interfaces
{
    public interface IGameManager
    {
        ...
        public Task<RomanTicTacToeGame> AddPawnAsync(int gameId, int playerId, int position);
        public Task<RomanTicTacToeGame>  RomanTicTacToeMakeMoveAsync(int gameId, int playerId, int oldPosition, int newPosition);
