...
namespace Tic_Tac_Toe_Web_API.Managers.Interfaces
{
    public interface IGameManager
    {
        ...
        public Task<RotaGame> RotaSelectMarkAsync(int gameId, int playerId, string playerMark);
        ...
        public Task<RotaGame> RotaRestartGameAsync(int gameId, int playerId);
        public Task<int> TicTacToeGetGameStateAsync(int gameId);
        public Task<int> RotaGetGameStateAsync(int gameId);
