...
//        [Test]
//        public void TicTacToeRestartGame_Should_Restart_Game_If_Second_Player_Restart_The_Game()
//        {
//            var player1 = _fixture.Build<Player>().With(p => p.Name, "to").Create();
//            var player2 = _fixture.Build<Player>().With(p => p.Name, "no").Create();
//            var game = _gameManager.CreateGame();
//            game.Players.Add(player1);
//            game.Players.Add(player2);
//            var restartedGame = _gameManager.TicTacToeRestartGame(game.GameId, player2.Id);
